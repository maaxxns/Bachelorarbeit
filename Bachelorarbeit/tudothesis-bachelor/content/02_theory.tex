\chapter{Theory}
This chapter will explain what \nameref{sec:terahertz} is, how to generate it through \nameref{sec:optic_ref}, and the detection through \nameref{sec:eos}.
...
\begin{figure}
    ...
    \label{fig:freq_mix}
\end{figure}\FloatBarrier
The field with frequency $\omega_\text{i}$ that goes into the crystal excites a higher energy level.
