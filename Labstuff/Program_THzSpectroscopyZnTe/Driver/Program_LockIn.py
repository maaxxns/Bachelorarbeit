# -*- coding: utf-8 -*-
"""
Created on Mon May 23 14:30:35 2022
...
#				  its coreesponding index inside of the SR830 serial.
	...
	"""
	def __init__(self,resourceLoc='ASRL4::INSTR'):#"GPIB0::5::INSTR"):
	...
	def get_All_Outputs(self):
		return(np.array([float(self.inst.query("OUTP? "+str(1))),float(self.inst.query("OUTP? "+str(2))),float(self.inst.query("OUTP? "+str(3))),float(self.inst.query("OUTP? "+str(4)))]))		
	def getXY(self):
